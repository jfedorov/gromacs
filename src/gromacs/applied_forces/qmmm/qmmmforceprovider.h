...
{
public:
    //! Construct force provider for QMMM from its parameters
...
private:
     ...
     */
    void initQMMMforce(const t_commrec& cr);
    ...
    // Number of times calculateForce has been called during the simultaion
    int step_ = 0;
