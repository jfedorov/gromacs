...
static const EnumerationArray<QMMMQMMethod, const char*> c_qmmmQMMethodNames = { { "PBE", "BLYP",
                                                                                   "INPUT" } };
...
struct QMMMParameters
{
    ...
    //! String containing name of the input file for QM program (default "topol.inp")
    std::string qmInputFileName_ = "topol.inp";
