...
private:
     ...
     */
    __device__ result_type rotLeft(result_type i, unsigned int bits)
    {
...
public:
    ...
    __device__ ThreeFry2x64General(uint64_t key0 = 0, RandomDomain domain = RandomDomain::Other)
    {
        seed(key0, domain);
    }
     ...
     */
    __device__ void seed(uint64_t key0 = 0, RandomDomain domain = RandomDomain::Other)
    {
     ...
     *          bits are nonzero. To test arbitrary values, use 0 internal counter bits.
     */
    __device__ void seed(uint64_t key0, uint64_t key1)
    {
...
public:
     ...
     *          bits are nonzero.
     */
        __device__ ThreeFry2x64(uint64_t key0 = 0, RandomDomain domain = RandomDomain::Other) :
