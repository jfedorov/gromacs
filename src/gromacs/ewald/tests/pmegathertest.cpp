...
SplineData getSplineData(const int pmeOrder, const int atomCount)
{
    ...
    //! A lot of random input spline values - should have at list (max PME order = 5) * (DIM = 3) * (total unique atom number in all test cases = 16) values
    // TODO should be 13? and below
