 ...
 * \param[in] pmeSize              Local PME grid size
 *
 * \tparam  forward                A boolean which tells whether to reduce values or just assign
 */
 ...
 *
 * \tparam  forward               A boolean which tells if this is conversion from PME grid to FFT grid or reverse
 */
template<bool forward>
