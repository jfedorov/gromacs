 ...
 * \param[in]  pfft_setup             Host FFT setup structure
 * \param[in]  gridIndex              Grid index which is to be converted
 */
template<bool forward>
void convertPmeGridToFftGrid(const PmeGpu* pmeGpu, float* h_grid, gmx_parallel_3dfft_t* pfft_setup, int gridIndex);
