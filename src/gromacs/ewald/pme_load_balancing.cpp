                                            ...
                                            bool                  useGpuPme)
{
    ...
    const int halo = extendedHaloRegion(pme_order, set.rlistOuter - set.rcut_coulomb, set.spacing);
                             ...
                             bool                           useGpuPme)
{
    ...
    else
    {
        ...
        gmx_pme_send_switchgrid(
                cr, set->grid, set->ewaldcoeff_q, set->ewaldcoeff_lj, set->rlistOuter, set->rcut_coulomb, set->spacing);
    }
