...
using gmx::ObservablesReducer;
using gmx::ObservablesReducerBuilder;
using gmx::RVec;
...
static ObservablesReducer init_em(FILE*                      fplog,
...
void LegacySimulator::do_cg()
{
    ...
    ObservablesReducer observablesReducer    = init_em(fplog,
                                                    mdlog,
                                                    CG,
                                                    cr,
                                                    inputrec,
