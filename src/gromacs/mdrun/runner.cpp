...
int Mdrunner::mdrunner()
{
    ...
    // TODO: This sets cr->dd->comm->systemInfo.cutoff. Should probably set it in ddBuilder instead?
    ...
    else
    {
        ...
        cr->sim_nodeid = cr->nodeIdOfDefaultCommunicator;
        cr->nodeid     = cr->nodeIdOfDefaultCommunicator;
        cr->npmenodes  = 0;
