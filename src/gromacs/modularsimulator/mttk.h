...
public:
     ...
     * \param propagatorTagPreVelocity  Tag of the propagators to scale velocities before propagation
     * \param propagatorTagPostVelocity  Tag of the propagators to scale velocities after propagation
     *
