...
void EnergySignaller::signal(Step step, Time time)
{
    ...
    const bool calculateEnergy = do_per_step(step, nstcalcenergy_) || writeEnergy || writeLog;
    const bool calculateVirial = ((virialMode_ == EnergySignallerVirialMode::OnStep
