...
#ifndef GROMACS_MODULARSIMULATOR_FIRSTORDERPRESSURECOUPLING_H
#    define GROMACS_MODULARSIMULATOR_FIRSTORDERPRESSURECOUPLING_H
...
#endif // GROMACS_MODULARSIMULATOR_FIRSTORDERPRESSURECOUPLING_H
