                                ...
                                const bool               useGpuForPme)
{
    ...
    ddSettings.initialDlbState = determineInitialDlbState(
            mdlog, options, ddSettings.recordLoad, mdrunOptions, ir, directGpuCommUsedWithGpuUpdate, useGpuForPme);
    GMX_LOG(mdlog.info)
...
public:
    ...
    Impl(const MDLogger&                   mdlog,
         ...
         bool                              gpuPmeDecompositionSupported);
    ...
    mdlog_(mdlog), cr_(cr), options_(options), mtop_(mtop), ir_(ir), notifiers_(notifiers)
{
    ...
    ddSettings_ = getDDSettings(
            mdlog_, options_, mdrunOptions, ir_, directGpuCommUsedWithGpuUpdate, useGpuForPme);
    ...
    auto separatePmeRanksPermitted = checkForSeparatePmeRanks(
            notifiers_, options_, numRanksRequested, useGpuForNonbonded, useGpuForPme, gpuPmeDecompositionSupported);
