...
void StatePropagatorDataGpu::Impl::reinit(int numAtomsLocal, int numAtomsAll)
{
    ...
    wallcycle_sub_start_nocount(wcycle_, WallCycleSubCounter::LAUNCH_STATE_PROPAGATOR_DATA);
    ...
    wallcycle_sub_stop(wcycle_, WallCycleSubCounter::LAUNCH_STATE_PROPAGATOR_DATA);
                                                        ...
                                                        AtomLocality atomLocality)
{
    ...
    wallcycle_start_nocount(wcycle_, WallCycleCounter::LAUNCH_GPU);
    wallcycle_sub_start(wcycle_, WallCycleSubCounter::LAUNCH_STATE_PROPAGATOR_DATA);
...
{
    wallcycle_start(wcycle_, WallCycleCounter::WAIT_GPU_STATE_PROPAGATOR_DATA);
    GMX_ASSERT(atomLocality < AtomLocality::Count, "Wrong atom locality.");
    xReadyOnDevice_[atomLocality].waitForEvent();
    wallcycle_stop(wcycle_, WallCycleCounter::WAIT_GPU_STATE_PROPAGATOR_DATA);
}
