...
std::unique_ptr<GmxNBForceCalculatorGpu>
GmxSetupDirector::setupGmxForceCalculatorGpu(const Topology&          topology,
...
std::unique_ptr<GmxNBForceCalculatorCpu>
GmxSetupDirector::setupGmxForceCalculatorCpu(TprReader& tprReader, const NBKernelOptions& options)
{
