...
if((_cuda_nvcc_executable_or_flags_changed OR CUDA_HOST_COMPILER_CHANGED OR NOT GMX_NVCC_WORKS) AND NOT WIN32)
    message(STATUS "Check for working combination of nvcc and C++ compiler with nvcc '${CUDA_NVCC_EXECUTABLE}'")
    ...
    elseif(NOT GMX_CUDA_TEST_COMPILER_QUIETLY)
        message(STATUS "Check for working combination of nvcc and C++ compiler - works")
